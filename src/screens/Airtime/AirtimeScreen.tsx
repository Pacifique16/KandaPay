...
import { buyAirtime } from '../../services/ussdService';
...
export default function AirtimeScreen() {
  ...
  const handleBuy = async () => {
    ...
    setLoading(true);
    const result = await buyAirtime(amount, detectedOperator, selectedSlot);
    setLoading(false);
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: '#34A853', padding: 16, borderRadius: 12, alignItems: 'center' },
